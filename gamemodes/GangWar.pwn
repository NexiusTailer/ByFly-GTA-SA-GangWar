...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(!strcmp(cmd, "/tune", true))
	{
		...
		if(PlayerInfo[playerid][pMoney] < 500) return SendClientMessage(playerid, COLOR_BORDO, "У вас нехватает денег!");
		if(!IsACar(GetPlayerVehicleID(playerid))) return SendClientMessage(playerid, COLOR_RED, "Тюнинг недоступен для этого транспорта!");
	...
	if(!strcmp(cmd, "/банды", true))
	{
		...
		if(!string2[0]) return ShowPlayerDialog(playerid, DIALOG_GANGS, DIALOG_STYLE_MSGBOX, "{FFFF00}Банды", "Банды не найдены", "Ок", "");
	...
	if(!strcmp(cmd, "/admins", true))
	{
		...
		if(!string2[0]) strcat(string2, "В данный момент нет админов онлайн");
...
public OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
	...
	switch(dialogid)
	{
		...
		case DIALOG_DMPOINTS_EXCHANGE:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_DMPOINTS_EXCHANGE, DIALOG_STYLE_INPUT, "{FFFF00}Обменять очки", "Напишите ниже, сколько очков вы хотите обменять\n3 очка = 1 килл", "Ок", "Назад");
		...
		case DIALOG_DMPOINTS_EXCHANGE_2:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_DMPOINTS_EXCHANGE_2, DIALOG_STYLE_INPUT, "{FFFF00}Обменять киллы", "Напишите ниже, сколько киллов вы хотите обменять\n1 килл = 3 очка", "Ок", "Назад");
				new amount = strval(inputtext);
		...
		case DIALOG_DMPOINTS_GIVE:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_DMPOINTS_GIVE, DIALOG_STYLE_INPUT, "{FFFF00}Передать очки", "Укажите ID игрока, которому хотите передать очки:", "Ок", "Назад");
		...
		case DIALOG_DMPOINTS_GIVE_2:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_DMPOINTS_GIVE_2, DIALOG_STYLE_INPUT, "{FFFF00}Передать очки", "Укажите количество очков, которое хотите передать:", "Ок", "Назад");
				new amount = strval(inputtext);
				if(amount < 1)
				{
		...
		case DIALOG_PVP_INVITE_1:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_PVP_INVITE_1, DIALOG_STYLE_INPUT, "{FFFF00}Пригласить на PVP", "Укажите ID оружия ниже:", "Ок", "Назад");
		...
		case DIALOG_PVP_INVITE_2:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_PVP_INVITE_2, DIALOG_STYLE_INPUT, "{FFFF00}Пригласить на PVP", "Укажите наличие брони (1/0) ниже:", "Ок", "Назад");
		...
		case DIALOG_PVP_INVITE_3:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_PVP_INVITE_3, DIALOG_STYLE_INPUT, "{FFFF00}Пригласить на PVP", "Укажите место (1-5) ниже:", "Ок", "Назад");
		...
		case DIALOG_PVP_INVITE_4:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_PVP_INVITE_4, DIALOG_STYLE_INPUT, "{FFFF00}Пригласить на PVP", "Укажите сумму ставки ниже:", "Ок", "Назад");
		...
		case DIALOG_GANG:
		{
			if(response)
			{
				switch(listitem)
				{
					case 0:
					{
						if(PlayerInfo[playerid][pGang] <= 0 && PlayerInfo[playerid][pKills] >= 300 && PlayerInfo[playerid][pMoney] >= 300000) ShowPlayerDialog(playerid, DIALOG_GANG_CREATE, DIALOG_STYLE_INPUT, "{FF0000}Создание банды", "Введите название банды:", "Принять", "Отмена");
					...
					case 1:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_SKIN_LEVEL, DIALOG_STYLE_LIST, "{FF0000}Назначение скинов", "Нуб\nИгрок\nДевушка\nЭлита\nЗам лидера\nЛидер", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде, и у вас должен быть уровень лидера.");
					}
					case 2:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pMoney] >= 300000 && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_SPAWN, DIALOG_STYLE_MSGBOX, "{FF0000}Назначение спавна", "Вы точно хотите назначить место спавна на этом месте?", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Для смены спавна требуется: уровень лидера и 300.000$");
					}
					case 3:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_LEVEL_ID, DIALOG_STYLE_INPUT, "{FF0000}Назначение уровня", "Введите id игрока, которому хотите назначить уровень:", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде, и у вас должен быть уровень лидера.");
					}
					case 4:
					{
					...
					case 5:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pGangLvl] >= 4) ShowPlayerDialog(playerid, DIALOG_GANG_INVITE, DIALOG_STYLE_INPUT, "{FF0000}Приглашение в банду", "Введите id игрока, которого хотите пригласить:", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде, и у вас должен быть как минимум 4 уровень.");
					}
					case 6:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pGangLvl] >= 5) ShowPlayerDialog(playerid, DIALOG_GANG_KICK, DIALOG_STYLE_INPUT, "{FF0000}Выгнать из банды", "Введите id игрока, которого хотите выгнать:", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде, и у вас должен быть как минимум 5 уровень.");
					}
					case 7:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_COLOR, DIALOG_STYLE_INPUT, "{FF0000}Смена цвета", "Введите 6 символов формата RRGGBB:", "Принять", "Отмена");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде, и у вас должен быть уровень лидера.");
					}
					case 8:
					{
						if(PlayerInfo[playerid][pGang] > 0 && PlayerInfo[playerid][pMoney] >= 300000 && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_NAME, DIALOG_STYLE_INPUT, "{FF0000}Смена названия", "Введите новое название банды\nв поле ниже:", "Принять", "Отмена");
					...
					case 10:
					{
						if(PlayerInfo[playerid][pGang] > 0) ShowPlayerDialog(playerid, DIALOG_GANG_EXIT, DIALOG_STYLE_MSGBOX, "{FF0000}Выход из банды", "Вы точно хотите уйти из банды?", "Да", "Нет");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в банде.");
					}
				}
			}
		...
		case DIALOG_GANG_SKIN:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_SKIN, DIALOG_STYLE_INPUT, "{FF0000}Назначение скинов", "Введите ID скина, который хотите назначить:", "Принять", "Отмена");
		...
		case DIALOG_GANG_INVITE:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_INVITE, DIALOG_STYLE_INPUT, "{FF0000}Приглашение в банду", "Введите id игрока, которого хотите пригласить:", "Принять", "Отмена");
		...
		case DIALOG_GANG_LEVEL_ID:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_LEVEL_ID, DIALOG_STYLE_INPUT, "{FF0000}Назначение уровня", "Введите id игрока, которому хотите назначить уровень:", "Принять", "Отмена");
				new player = strval(inputtext);
		...
		case DIALOG_GANG_STOCK_GIVE:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_GIVE, DIALOG_STYLE_INPUT, "{FFFF00}Положить деньги", "Укажите сумму, которую вы хотите положить в общак:", "Ок", "Назад");
				new amount = strval(inputtext);
				if(amount < 1)
				{
		...
		case DIALOG_GANG_STOCK_TAKE:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_TAKE, DIALOG_STYLE_INPUT, "{FFFF00}Взять деньги", "Укажите сумму, которую вы хотите взять с общака:", "Ок", "Назад");
				new amount = strval(inputtext);
				if(amount < 1)
				{
					SendClientMessage(playerid, COLOR_RED_GANG, "Вы указали неверную сумму!");
		...
		case DIALOG_GANG_STOCK_GIVE_POINTS:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_GIVE_POINTS, DIALOG_STYLE_INPUT, "{FFFF00}Положить DM-очки", "Укажите количество DM-очков, которое вы хотите положить в общак:", "Ок", "Назад");
				new amount = strval(inputtext);
				if(amount < 1)
				{
		...
		case DIALOG_GANG_STOCK_TAKE_POINTS:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_TAKE_POINTS, DIALOG_STYLE_INPUT, "{FFFF00}Взять DM-очки", "Укажите количество DM-очков, которое вы хотите взять с общака:", "Ок", "Назад");
				new amount = strval(inputtext);
				if(amount < 1)
				{
					SendClientMessage(playerid, COLOR_RED_GANG, "Вы указали неверное количество!");
		...
		case DIALOG_GANG_KICK:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_KICK, DIALOG_STYLE_INPUT, "{FF0000}Выгнать из банды", "Введите id игрока, которого хотите выгнать:", "Принять", "Отмена");
				new player = strval(inputtext);
				if(!IsPlayerConnected(player)) return SendClientMessage(playerid, -1, "Этот игрок не в игре!");
		...
		case DIALOG_GANG_COLOR:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_COLOR, DIALOG_STYLE_INPUT, "{FF0000}Смена цвета", "Введите 6 символов формата RRGGBB:", "Принять", "Отмена");
		...
		case DIALOG_GANG_CREATE_COLOR:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_GANG_CREATE_COLOR, DIALOG_STYLE_INPUT, "{FF0000}Создание банды", "Введите цвет банды:", "Принять", "Отмена");
				if(strlen(inputtext) != 6)
				{
					SendClientMessage(playerid, COLOR_RED_GANG, "Значение должно быть из 6 символов формата RRGGBB!");
					ShowPlayerDialog(playerid, DIALOG_GANG_CREATE_COLOR, DIALOG_STYLE_INPUT, "{FF0000}Создание банды", "Введите цвет банды:", "Принять", "Отмена");
			...
			if(response)
			{
				switch(listitem)
				{
					case 0:
					{
						...
						if(!string2[0]) strcat(string2, "В данный момент нет членов банды онлайн");
		...
		case DIALOG_CHANGE_NUMBER:
		{
			if(response)
			{
				if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_CHANGE_NUMBER, DIALOG_STYLE_INPUT, "{FFFF00}Смена номера", "Введите новый номер автомобиля:", "Принять", "Отмена");
		...
		case DIALOG_RACE_CREATE_1, DIALOG_RACE_CREATE_1_ERROR:
		{
			...
			if(!(1 <= strlen(inputtext) <= 20)) return ShowPlayerDialog(playerid, DIALOG_RACE_CREATE_1_ERROR, DIALOG_STYLE_INPUT, "{FFFF00}Создание новой гонки (Этап 1/4)", "ОШИБКА: Имя слишком длинное либо слишком короткое! (мин. 1 - макс. 20)\n\n\n\
			Этап 1:\n********\nДобро пожаловать в мастер 'создания новой гонки'.\nПеред началом, мне нужно узнать имя гокни (например, SFRace) для её сохранения.\n\n>> Введите имя ниже и нажмите 'Далее' для продолжения.", "Далее", "Назад");
		...
		case DIALOG_RACE_CREATE_2, DIALOG_RACE_CREATE_2_ERROR:
		{
			...
			if(!inputtext[0]) return ShowPlayerDialog(playerid, DIALOG_RACE_CREATE_2_ERROR, DIALOG_STYLE_INPUT, "{FFFF00}Создание новой гонки (Этап 2/4)", "ОШИБКА: Неверный ID/Имя автомобиля\n\n\nЭтап 2:\n********\n\
			Пожалуйста, укажите ID или ИМЯ автомобиля, который будет использоваться в этой гонке.\n\n>> Введите ID или ИМЯ автомобиля ниже и нажмите 'Далее' для продолжения. 'Назад', чтобы что-то изменить.", "Далее", "Назад");
			new model;
