...
#define DIALOG_TP						(DIALOG_PVP + 1)
#define DIALOG_TPLS						(DIALOG_TP + 1)
#define DIALOG_TPSF						(DIALOG_TPLS + 1)
#define DIALOG_TPLV						(DIALOG_TPSF + 1)
#define DIALOG_TP_OTHER					(DIALOG_TPLV + 1)
#define DIALOG_STATS					(DIALOG_TP_OTHER + 1)
...
#define DIALOG_GANG_STOCK_GIVE_POINTS	(DIALOG_GANG_STOCK_TAKE + 1)
#define DIALOG_GANG_STOCK_TAKE_POINTS	(DIALOG_GANG_STOCK_GIVE_POINTS + 1)
#define DIALOG_GANG_BATTLE				(DIALOG_GANG_STOCK_TAKE_POINTS + 1)
			...
			if(response)
			{
				switch(listitem)
				{
					case 0:
					{
						...
						format(string, sizeof string, "{FFFF00}Общак банды \"%s\"", GName[PlayerInfo[playerid][pGangId]]);
						format(string2, sizeof string2, "Денег в общаке: $%d\nDM очков в общаке: %d", GMoney[PlayerInfo[playerid][pGangId]], GDMPoints[PlayerInfo[playerid][pGangId]]);
					...
					case 3:
					{
						if(PlayerInfo[playerid][pGang] == PlayerInfo[playerid][pGangId]) ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_GIVE_POINTS, DIALOG_STYLE_INPUT, "{FFFF00}Положить DM-очки", "Укажите количество DM-очков, которое вы хотите положить в общак:", "Ок", "Назад");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в этой банде.");
					}
					case 4:
					{
						if(PlayerInfo[playerid][pGang] == PlayerInfo[playerid][pGangId] && PlayerInfo[playerid][pGangLvl] == 6) ShowPlayerDialog(playerid, DIALOG_GANG_STOCK_TAKE_POINTS, DIALOG_STYLE_INPUT, "{FFFF00}Взять DM-очки", "Укажите количество DM-очков, которое вы хотите взять с общака:", "Ок", "Назад");
						else SendClientMessage(playerid, COLOR_RED_GANG, "Вы должны состоять в этой банде, и у вас должен быть уровень лидера.");
					}
				}
			}
