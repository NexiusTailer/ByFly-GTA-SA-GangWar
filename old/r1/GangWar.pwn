...
#define DIALOG_LOGIN					(DIALOG_REGISTRATION + 1)
#define DIALOG_RULES					(DIALOG_LOGIN + 1)
#define DIALOG_GLASSES					(DIALOG_RULES + 1)
#define DIALOG_DRINK					(DIALOG_GLASSES + 1)
#define DIALOG_RADIO					(DIALOG_DRINK + 1)
#define DIALOG_PVP						(DIALOG_RADIO + 1)
#define DIALOG_TPLS						(DIALOG_PVP + 1)
#define DIALOG_TPSF						(DIALOG_TPLS + 1)
#define DIALOG_TPLV						(DIALOG_TPSF + 1)
#define DIALOG_STATS					(DIALOG_TPLV + 1)
#define DIALOG_HELP						(DIALOG_STATS + 1)
#define DIALOG_ABOUT					(DIALOG_HELP + 1)
#define DIALOG_ACTIONS					(DIALOG_ABOUT + 1)
#define DIALOG_SPEC_ACTIONS				(DIALOG_ACTIONS + 1)
#define DIALOG_FIGHTING_STYLES			(DIALOG_SPEC_ACTIONS + 1)
#define DIALOG_ANIMATION				(DIALOG_FIGHTING_STYLES + 1)
#define DIALOG_ICOMMANDS				(DIALOG_ANIMATION + 1)
#define DIALOG_PLAYER_INFO				(DIALOG_ICOMMANDS + 1)
#define DIALOG_PLAYER_MENU				(DIALOG_PLAYER_INFO + 1)
#define DIALOG_DMPOINTS					(DIALOG_PLAYER_MENU + 1)
#define DIALOG_DMPOINTS_EXCHANGE		(DIALOG_DMPOINTS + 1)
#define DIALOG_DMPOINTS_EXCHANGE_2		(DIALOG_DMPOINTS_EXCHANGE + 1)
#define DIALOG_DMPOINTS_GIVE			(DIALOG_DMPOINTS_EXCHANGE_2 + 1)
#define DIALOG_DMPOINTS_GIVE_2			(DIALOG_DMPOINTS_GIVE + 1)
#define DIALOG_PM						(DIALOG_DMPOINTS_GIVE_2 + 1)
#define DIALOG_GIVE_MONEY				(DIALOG_PM + 1)
#define DIALOG_REPORT					(DIALOG_GIVE_MONEY + 1)
#define DIALOG_PVP_INVITE_1				(DIALOG_REPORT + 1)
#define DIALOG_PVP_INVITE_2				(DIALOG_PVP_INVITE_1 + 1)
#define DIALOG_PVP_INVITE_3				(DIALOG_PVP_INVITE_2 + 1)
#define DIALOG_PVP_INVITE_4				(DIALOG_PVP_INVITE_3 + 1)
#define DIALOG_TUNING					(DIALOG_PVP_INVITE_4 + 1)
#define DIALOG_TUNING_COLOR				(DIALOG_TUNING + 1)
#define DIALOG_TUNING_COLOR_2			(DIALOG_TUNING_COLOR + 1)
#define DIALOG_TUNING_WHEELS			(DIALOG_TUNING_COLOR_2 + 1)
#define DIALOG_TUNING_PAINTJOB_1		(DIALOG_TUNING_WHEELS + 1)
#define DIALOG_TUNING_PAINTJOB_2		(DIALOG_TUNING_PAINTJOB_1 + 1)
#define DIALOG_TUNING_PAINTJOB_3		(DIALOG_TUNING_PAINTJOB_2 + 1)
#define DIALOG_TUNING_PAINTJOB_4		(DIALOG_TUNING_PAINTJOB_3 + 1)
#define DIALOG_TUNING_PAINTJOB_5		(DIALOG_TUNING_PAINTJOB_4 + 1)
#define DIALOG_TUNING_COMPONENTS		(DIALOG_TUNING_PAINTJOB_5 + 1)
#define DIALOG_TUNING_SPOILERS_1		(DIALOG_TUNING_COMPONENTS + 1)
#define DIALOG_TUNING_SPOILERS_2		(DIALOG_TUNING_SPOILERS_1 + 1)
#define DIALOG_TUNING_LIGHTS			(DIALOG_TUNING_SPOILERS_2 + 1)
#define DIALOG_TUNING_VENTS				(DIALOG_TUNING_LIGHTS + 1)
#define DIALOG_ELEVATOR					(DIALOG_TUNING_VENTS + 1)
#define DIALOG_RACE						(DIALOG_ELEVATOR + 1)
#define DIALOG_VEHICLE					(DIALOG_RACE + 1)
#define	DIALOG_GANG						(DIALOG_VEHICLE + 1)
#define	DIALOG_GANG_CREATE				(DIALOG_GANG + 1)
#define DIALOG_GANG_CREATED				(DIALOG_GANG_CREATE + 1)
#define	DIALOG_GANG_SKIN				(DIALOG_GANG_CREATED + 1)
#define	DIALOG_GANG_INVITE				(DIALOG_GANG_SKIN + 1)
#define	DIALOG_GANG_EXIT				(DIALOG_GANG_INVITE + 1)
#define	DIALOG_GANG_SPAWN				(DIALOG_GANG_EXIT + 1)
#define	DIALOG_GANG_LEVEL_ID			(DIALOG_GANG_SPAWN + 1)
#define	DIALOG_GANG_LEVEL				(DIALOG_GANG_LEVEL_ID + 1)
#define	DIALOG_GANG_KICK				(DIALOG_GANG_LEVEL + 1)
#define	DIALOG_GANG_COLOR				(DIALOG_GANG_KICK + 1)
#define	DIALOG_GANG_NAME				(DIALOG_GANG_COLOR + 1)
#define	DIALOG_GANG_NAME_CHANGED		(DIALOG_GANG_NAME + 1)
#define	DIALOG_GANG_SKIN_LEVEL			(DIALOG_GANG_NAME_CHANGED + 1)
#define	DIALOG_GANG_INV_ACCEPT			(DIALOG_GANG_SKIN_LEVEL + 1)
#define	DIALOG_GANG_CREATE_COLOR		(DIALOG_GANG_INV_ACCEPT + 1)
#define DIALOG_GANGS					(DIALOG_GANG_CREATE_COLOR + 1)
#define DIALOG_GANGS_MENU				(DIALOG_GANGS + 1)
#define DIALOG_GANG_ONLINE				(DIALOG_GANGS_MENU + 1)
#define DIALOG_ADMINS					(DIALOG_GANG_ONLINE + 1)
#define	DIALOG_AVTO						(DIALOG_ADMINS + 1)
#define DIALOG_PVP_ABOUT				(DIALOG_AVTO + 1)
#define	DIALOG_CHANGE_NUMBER			(DIALOG_PVP_ABOUT + 1)
#define	DIALOG_NEON						(DIALOG_CHANGE_NUMBER + 1)
#define DIALOG_RACES					(DIALOG_NEON + 1)
#define DIALOG_RACE_TOP					(DIALOG_RACES + 1)
#define DIALOG_RACE_CREATE				(DIALOG_RACE_TOP + 1)
#define DIALOG_RACE_CREATE_1			(DIALOG_RACE_CREATE + 1)
#define DIALOG_RACE_CREATE_1_ERROR		(DIALOG_RACE_CREATE_1 + 1)
#define DIALOG_RACE_CREATE_2			(DIALOG_RACE_CREATE_1_ERROR + 1)
#define DIALOG_RACE_CREATE_2_ERROR		(DIALOG_RACE_CREATE_2 + 1)
#define DIALOG_RACE_CREATE_3			(DIALOG_RACE_CREATE_2_ERROR + 1)
#define DIALOG_RACE_CREATE_4			(DIALOG_RACE_CREATE_3 + 1)
#define DIALOG_RACE_CREATE_DONE			(DIALOG_RACE_CREATE_4 + 1)
...
public OnGameModeInit()
{
	...
	ResetElevatorQueue();
	ElevatorInitialize();
	for( ; i < sizeof RulesMsg; i++) strcat(RulesStr, RulesMsg[i]);
	...
	AddStaticVehicle(558, 1374.5, 2651.3, 10.5, 0.0, 66, 31);
	AddStaticVehicle(559, 1363.6, 2651.2, 10.6, 0.0, 48, 79);
	AddStaticVehicle(560, 1352.5, 2651.2, 10.6, 0.0, 77, 98);
	AddStaticVehicle(562, 1341.4, 2651.1, 10.6, 0.0, 109, 108);
	AddStaticVehicle(565, 1330.2, 2651.2, 10.5, 0.0, 101, 106);
	AddStaticVehicle(587, 1319.1, 2651.3, 10.6, 0.0, 88, 88);
	AddStaticVehicle(602, 1307.9, 2651.1, 10.7, 0.0, 100, 100);
	AddStaticVehicle(603, 1296.8, 2650.8, 10.8, 0.0, 123, 10);
	AddStaticVehicle(496, 1285.7, 2650.9, 10.6, 0.0, 22, 34);
	AddStaticVehicle(535, 1274.9, 2651.3, 10.7, 0.0, 132, 4);
	AddStaticVehicle(495, 1264.9, 2651.4, 11.4, 0.0, 163, 173);
	AddStaticVehicle(424, 1265.0, 2693.8, 10.7, 180.0, 42, 119);
	AddStaticVehicle(434, 1275.0, 2693.9, 11.0, 180.0, 93, 126);
	AddStaticVehicle(494, 1285.8, 2694.0, 10.8, 180.0, 32, 32);
	AddStaticVehicle(502, 1296.8, 2694.0, 10.8, 180.0, 14, 49);
	AddStaticVehicle(503, 1307.9, 2693.9, 10.8, 180.0, 77, 132);
	AddStaticVehicle(568, 1319.1, 2694.5, 10.8, 180.0, 115, 46);
	AddStaticVehicle(402, 1330.2, 2693.9, 10.8, 180.0, 105, 30);
	AddStaticVehicle(411, 1341.3, 2693.9, 10.6, 180.0, 98, 68);
	AddStaticVehicle(415, 1352.5, 2693.8, 10.7, 180.0, 109, 108);
	AddStaticVehicle(451, 1363.7, 2693.8, 10.6, 180.0, 37, 37);
	AddStaticVehicle(541, 1374.7, 2693.9, 10.5, 180.0, 105, 30);
...
public OnGameModeExit()
{
	...
	for(i = GetPlayerPoolSize(); i != -1; --i)
	{
		if(IsPlayerConnected(i))
		{
			...
			KillTimer(PlayerInfo[i][pPorvuTmr]);
...
public OnPlayerConnect(playerid)
{
	...
	PlayerInfo[playerid][pPorvu] = true;
	...
	PlayerInfo[playerid][pPorvuTmr] = -1;
...
public OnPlayerDisconnect(playerid, reason)
{
	...
	KillTimer(PlayerInfo[playerid][pPorvuTmr]);
...
public OnPlayerSpawn(playerid)
{
	...
	if(PlayerInfo[playerid][pJail])
	{
		...
		PlayAudioStreamForPlayer(playerid, "http://www.ex.ua/get/162890556");
	...
	if(killerid != INVALID_PLAYER_ID)
	{
		...
		switch(PlayerInfo[killerid][pKills])
		{
			case 50:
			{
				...
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[0], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
			case 100:
			{
				SendClientMessageToAll(COLOR_BORDO, "____________________________");
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[1], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
			case 150:
			{
				SendClientMessageToAll(COLOR_BORDO, "____________________________");
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[2], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
			case 200:
			{
				SendClientMessageToAll(COLOR_BORDO, "____________________________");
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[3], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
			case 250:
			{
				SendClientMessageToAll(COLOR_BORDO, "____________________________");
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[4], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
			case 500:
			{
				SendClientMessageToAll(COLOR_BORDO, "____________________________");
				format(string, sizeof string, "...::: [%s] присваевается звание \"%s (%d kill's)\" :::...", PlayerInfo[killerid][pName], Ranks[5], PlayerInfo[killerid][pKills]);
				SendClientMessageToAll(GetPlayerColor(killerid), string);
			}
		}
	}
...
public OnPlayerText(playerid, text[])
{
	...
	for(new s, i, pos; s < sizeof Swears; s++)
	{
		while((pos = strfind(text, Swears[s], true)) != -1)
		{
			for(i = (pos + strlen(Swears[s])) - 1; i >= pos; --i) text[i] = '*';
		}
	}
	...
	if(text[0] == '#' && IsPlayerAdminEx(playerid, 1))
	{
		if(IsEmptyMessage(text[1])) return 0;
		new string[145];
		format(string, sizeof string, "* Админ-чат: %s: %s", PlayerInfo[playerid][pName], text[1]);
...
public OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(!strcmp(cmd, "/stats", true))
	{
		...
		if(!strlen(tmp))
		{
			...
			format(string2, sizeof string2, "Убийств: %d\nСмертей: %d\nПоказатель: %0.2f\nОчков: %d\nDM Points: %d\nБанда: %s\nУровень в банде: %d\nДеньги: $%d\nВремя на сервере: %d час\nПодключений к серверу: %d", PlayerInfo[playerid][pKills], PlayerInfo[playerid][pDeaths], float(PlayerInfo[playerid][pKills]) / float(PlayerInfo[playerid][pDeaths]),
			PlayerInfo[playerid][pPoints], PlayerInfo[playerid][pDmPoints], (strlen(GName[PlayerInfo[playerid][pGang]]) ? GName[PlayerInfo[playerid][pGang]] : "Нет"), PlayerInfo[playerid][pGangLvl], PlayerInfo[playerid][pMoney], floatround(PlayerInfo[playerid][pSeconds] / 3600, floatround_tozero), PlayerInfo[playerid][pConnectCount]);
		...
		format(string2, sizeof string2, "Убийств: %d\nСмертей: %d\nПоказатель: %0.2f\nОчков: %d\nDM Points: %d\nБанда: %s\nУровень в банде: %d\nДеньги: $%d\nВремя на сервере: %d час\nПодключений к серверу: %d", PlayerInfo[player][pKills], PlayerInfo[player][pDeaths], float(PlayerInfo[player][pKills]) / float(PlayerInfo[player][pDeaths]),
		PlayerInfo[player][pPoints], PlayerInfo[player][pDmPoints], (strlen(GName[PlayerInfo[player][pGang]]) ? GName[PlayerInfo[player][pGang]] : "Нет"), PlayerInfo[player][pGangLvl], PlayerInfo[player][pMoney], floatround(PlayerInfo[player][pSeconds] / 3600, floatround_tozero), PlayerInfo[player][pConnectCount]);
		ShowPlayerDialog(playerid, DIALOG_STATS, DIALOG_STYLE_MSGBOX, string, string2, "Ок", "");
		return 1;
	}
	...
	if(!strcmp(cmd, "/icommands", true)) return ShowPlayerDialog(playerid, DIALOG_ICOMMANDS, DIALOG_STYLE_MSGBOX, "{FFFF00}Команды сервера", "/stats - показать свою статистику\n/stats [id] - показать статистику игрока\n\
	...
	if(!strcmp(cmd, "/мигалка", true))
	{
		...
		else
		{
			...
			AttachObjectToVehicle(Flasher[vehid], vehid, -0.0, -0.2, 0.70, 1.0, 1.0, 1.0);
		}
		return 1;
	}
	...
	{
		if(!PlayerInfo[playerid][pPorvu]) return SendClientMessage(playerid, COLOR_BORDO, "*** Данную команду можно использовать не чаще, чем 1 раз в 30 секунд!");
		format(string, sizeof string, "..:: %s обещает всех порвать!!! ::..", PlayerInfo[playerid][pName]);
		SendClientMessageToAll(COLOR_LIME, string);
		PlayerInfo[playerid][pPorvuTmr] = SetTimerEx("Porvu", 1000 * 30, 0, "i", playerid);
		PlayerInfo[playerid][pPorvu] = false;
		return 1;
	}
	...
	if(!strcmp(cmd, "/givecar", true))
	{
		...
		format(string, sizeof string, "Вы выдали игроку %s транспорт. Модель: %d", PlayerInfo[player][pName], modelid);
		SendClientMessage(playerid, COLOR_BLUE, string);
		format(string, sizeof string, "Админ %s выдал Вам транспорт. Модель: %d", PlayerInfo[playerid][pName], modelid);
	...
	if(!strcmp(cmd, "/setmoney", true))
	{
		...
		format(string, sizeof string, "Вы установили $%d игроку %s", money, PlayerInfo[player][pName]);
		SendClientMessage(playerid, COLOR_BLUE, string);
		format(string, sizeof string, "Админ %s установил Вам $%d", PlayerInfo[playerid][pName], money);
		SendClientMessage(player, COLOR_BLUE, string);
	...
	switch(dialogid)
	{
		...
		case DIALOG_TPLS:
		{
			if(response)
			{
				...
				switch(listitem)
				{
					case 0:
					{
						SetPlayerPos(playerid, -1428.5691, -283.3028, 14.1484);
						format(string, sizeof string, "*** %s телепортировался в Airport San Fierro", PlayerInfo[playerid][pName]);
						SetCameraBehindPlayer(playerid);
					}
					case 1:
					{
						SetPlayerPos(playerid, 1676.7448, 1447.6849, 10.7836);
						format(string, sizeof string, "*** %s телепортировался в Airport Las Venturas", PlayerInfo[playerid][pName]);
						SetCameraBehindPlayer(playerid);
					}
				}
				SetPlayerInterior(playerid, 0);
		...
		case DIALOG_TPSF:
		{
			if(response)
			{
				...
				switch(listitem)
				{
					case 0:
					{
						SetPlayerPos(playerid, 1685.5046, -2240.9297, -2.6976);
						format(string, sizeof string, "*** %s телепортировался в Airport Los Santos", PlayerInfo[playerid][pName]);
						SetCameraBehindPlayer(playerid);
					}
					case 1:
					{
		...
		case DIALOG_HELP:
		{
			if(response)
			{
				switch(listitem)
				{
					...
					case 1: ShowPlayerDialog(playerid, DIALOG_RACE, DIALOG_STYLE_MSGBOX, "{FFFF00}Справка по гонке", "Для того чтобы начать создавать гонку (для админов), наберите: /buildrace\nДалее руководствуйтесь подсказками диалогового окна\nПросмотр победителей гонки: /toprace [имя гонки]\nЧтобы удалить гонку (для админов), наберите: /delrace [имя гонки]\n\
		...
		case DIALOG_GANGS:
		{
			if(response && listitem >= 0)
			{
				...
				ShowPlayerDialog(playerid, DIALOG_GANGS_MENU, DIALOG_STYLE_LIST, string, "Члены банды онлайн", "Выбрать", "Назад");
			}
		}
			...
			if(response)
			{
				switch(listitem)
				{
					case 0:
					{
						...
						ShowPlayerDialog(playerid, DIALOG_GANG_ONLINE, DIALOG_STYLE_MSGBOX, "{FFFF00}Члены банды онлайн", string, "Ок", "Назад");
					}
				}
			}
		...
		case DIALOG_NEON:
		{
			if(!response) return ShowPlayerDialog(playerid, DIALOG_AVTO, DIALOG_STYLE_LIST, "{FFFF00}Авто-меню", "{00FF7F}Запустить мотор\n{00FF7F}Открыть капот Num 4\n{00FF7F}Открыть багажник		Num 6\n{00FF7F}Включить светNum +\n{00FF7F}Включить сигнализацию\n\
			{00FF7F}Закрыть двери\n{FA8072}Закрыть капот Num 4\n{FA8072}Закрыть багажник		Num 6\n{FA8072}Выключить свет		Num +\n{FA8072}Выключить сигнализацию\n{FA8072}Открыть двери\n{FA8072}Заглушить мотор\n{FF0000}Н{004DFF}е{10F441}о{FFFF00}н\n{33CCFF}Сменить номер", "Выбрать", "Отмена");
			switch(listitem)
			{
				case 0:
		...
		{
			if(!response) return ShowPlayerDialog(playerid, DIALOG_RACE_CREATE_3, DIALOG_STYLE_MSGBOX, "{FFFF00}Создание новой гонки (Этап 3/4)", "Этап 3:\n********\nМы почти закончили! Теперь перейдите к линии старта, где должны стоять первый и второй автомобили.\nПримечание: после нажатия 'Ок' Вы будете свободны. Используйте 'KEY_FIRE', чтобы установить первую и вторую позицию.\n\
			Примечание: После того, как Вы получите эти позиции, Вы автоматически увидите диалоговое окно для продолжения настройки.\n\n>> Нажмите 'Ок', чтобы сделать описанные выше действия. 'Назад', чтобы что-то изменить.", "Ок", "Назад");
...
{
	if(pickupid == TPls) return ShowPlayerDialog(playerid, DIALOG_TPLS, DIALOG_STYLE_LIST, "{FFFF00}Меню телепорта", "Airport San Fierro\nAirport Las Venturas", "Ок", "Отмена");
	if(pickupid == TPsf) return ShowPlayerDialog(playerid, DIALOG_TPSF, DIALOG_STYLE_LIST, "{FFFF00}Меню телепорта", "Airport Los Santos\nAirport Las Venturas", "Ок", "Отмена");
	if(pickupid == TPlv) return ShowPlayerDialog(playerid, DIALOG_TPLV, DIALOG_STYLE_LIST, "{FFFF00}Меню телепорта", "Airport Los Santos\nAirport San Fierro", "Ок", "Отмена");
	if(pickupid == TPChina)
	{
...
public OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
	if(IsPlayerInAnyVehicle(playerid))
	{
		...
		{
			OnPlayerCommandText(playerid, "/tune");
			new vehid = GetPlayerVehicleID(playerid), engine, lights, alarm, doors, bonnet, boot, objective;
			GetVehicleParamsEx(vehid, engine, lights, alarm, doors, bonnet, boot, objective);
			SetVehicleParamsEx(vehid, engine, !lights, alarm, doors, bonnet, boot, objective);
			return 1;
		}
		if(newkeys & KEY_ANALOG_LEFT) OnPlayerCommandText(playerid, "/bonnet");
		if(newkeys & KEY_ANALOG_RIGHT) OnPlayerCommandText(playerid, "/boot");
	}
	else
	{
...
RegularCarDialog(playerid)
{
	switch(GetVehicleModel(GetPlayerVehicleID(playerid)))
	{
		case 549: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[1], "Выбрать", "Назад");
		case 550: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[2], "Выбрать", "Назад");
		case 585, 603: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[3], "Выбрать", "Назад");
		case 410, 436: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[4], "Выбрать", "Назад");
		case 439, 458: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[5], "Выбрать", "Назад");
		case 551, 492, 529: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[6], "Выбрать", "Назад");
		case 489, 505: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[7], "Выбрать", "Назад");
		case 516: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[8], "Выбрать", "Назад");
		case 491, 517: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[9], "Выбрать", "Назад");
		case 418, 527, 580: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[10], "Выбрать", "Назад");
		case 420, 587: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[11], "Выбрать", "Назад");
		case 547: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[12], "Выбрать", "Назад");
		case 415: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[13], "Выбрать", "Назад");
		default: ShowPlayerDialog(playerid, DIALOG_TUNING_COMPONENTS, DIALOG_STYLE_LIST, "{FFFF00}Меню тюнинга", RegularCarStrings[0], "Выбрать", "Назад");
	}
	return 1;
}
